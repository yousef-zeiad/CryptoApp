...
const Page = () => {
  ...
  return (
    <BlurView
      intensity={80}
      tint={"light"}
      style={{ flex: 1, paddingTop: 100, backgroundColor: "rgba(0,0,0,0.1)" }}
    >
      ...
      <View style={styles.actions}>
        ...
        <TouchableOpacity style={styles.btn}>
          ...
          <Text style={{ color: "#000", fontSize: 18 }}>Learn</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.btn}>
          <Ionicons name="megaphone" size={24} color={"#000"} />
          <Text style={{ color: "#000", fontSize: 18, flex: 1 }}>Inbox</Text>
          <View
            style={{
      ...
      <View style={styles.actions}>
        {ICONS.map((icon) => (
          ...
          >
            ...
            <Text style={{ color: "#000", fontSize: 18 }}>{icon.name}</Text>
